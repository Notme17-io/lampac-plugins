(function () {
  ...
  function addCSS() {
    ...
    var css = 
      ...
      /* Панель тулбара с подписями СОРТИРОВАТЬ и ФИЛЬТР */
      '.nova-t-toolbar{display:flex;align-items:center;gap:.7em;margin-bottom:1.2em;flex-wrap:wrap}\n' +
      '.nova-t-label{font-size:.85em;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,0.45);margin-left:.3em;margin-right:-.2em;white-space:nowrap}\n' +
      '.nova-t-chip{display:inline-flex;align-items:center;gap:.5em;padding:.4em 1em;border-radius:2em;background:rgba(255,255,255,0.07);color:#fff;font-size:.95em;cursor:pointer;white-space:nowrap}\n' +
      ...
      '.nova-t-chip svg{width:1.05em!important;height:1.05em!important;max-width:1.05em!important;max-height:1.05em!important;flex-shrink:0!important}\n' +
      
      /* Карточки с баннером слева */
      ...
      '.nova-t-card__thumb{position:relative;width:5.4em;height:5.4em;flex-shrink:0;border-radius:.5em;overflow:hidden;background:rgba(0,0,0,0.45);margin-right:1.3em;margin-top:.15em}\n' +
      '.nova-t-card__thumb img{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;opacity:.75}\n' +
      '.nova-t-card__num{position:absolute;top:0;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:center;font-size:1.1em;font-weight:700;color:#fff;text-shadow:0 .05em .2em rgba(0,0,0,.9);z-index:2}\n' +
      '.nova-t-card__num>span{display:inline-block;padding:.08em .35em;border-radius:.3em;background:rgba(10,11,17,0.65);box-shadow:0 .12em .45em rgba(0,0,0,.5)}\n' +
  ...
  function renderNovaTorrents() {
    ...
    // Сортировка и Фильтр с вынесенными подписями
    origHead.find('.filter--sort, .filter--filter').each(function () {
      ...
      var fullText = val ? val : label;
      var icon = isSort ? ICON.sort : ICON.filter;

      var textLabel = $('<div class="nova-t-label">' + label + '</div>');
