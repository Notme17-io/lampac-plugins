(function () {
    ...
    function initStyles() {
        ...
        var css = 
            ...
            /* Цвет бейджа Фильм/Сериал точно такой же как на главной: полупрозрачный белый с размытием */\n' +
            ...
            /* Полное скрытие нативных фокусных полосок под кнопками в карточке */\n' +
            '.full-start-new__button::after, .full-start__button::after, .full-start-new__button::before, .full-start__button::before, .button--navigation::after, .button--navigation::before, .button__focus, .full-start-new__button .focus::after, .full-start__button .focus::after{display:none!important;content:none!important}\n' +
            '.full-start-new__buttons .focus::after, .full-start__buttons .focus::after, .full-start-new__buttons .focus::before, .full-start__buttons .focus::before{display:none!important;content:none!important}\n' +
            '.full-start-new__button.focus, .full-start__button.focus{box-shadow:inset 0 0 0 2px #fff!important}\n' +
    ...
    var manifest = {
        name: 'Cards Style',
        version: '1.3.7',
        description: 'Классический стиль карточек, полупрозрачный бейдж в деталях, скрытые фокусные полоски под кнопками'
    };
